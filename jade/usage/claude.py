#!/usr/bin/python3
# Vendored from Omarchy (https://github.com/omacom/omarchy), bin/omarchy-agent-usage-claude
...
# "Jade:" and limited to the cache location.
...
def cache_root() -> Path:
  ...
  root = Path(os.environ.get("XDG_CACHE_HOME", Path.home() / ".cache")) / "jade-shell" / "usage" / "scan"
