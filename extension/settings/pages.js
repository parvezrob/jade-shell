...
// and the Jade Shell app (jade-shell-settings) directly.
...
export class Pages {
    constructor({settings, metadata, dir}) {
        this._settings = settings;
        this.metadata = metadata;
        this.dir = dir;
    }

    // Every page, into an Adw.PreferencesWindow: GNOME's Extensions app
    // (prefs.js) and the Jade Shell app both call this.
    fill(window) {
        ...
        const usagePage = new Adw.PreferencesPage({name: 'usage', title: 'AI Usage', icon_name: 'ai-usage-symbolic'});
